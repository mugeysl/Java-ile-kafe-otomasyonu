...
public class AraSicaklar {
	...
	public void listeOlusturma() throws IOException {
		...
		File file = new File("AraSicaklar.txt");
		if (!file.exists()) {
			file.createNewFile();
		}
	...
	public void ekle() throws IOException {
		...
		System.out.print("Ad�:");
		String araSicakAdi = scan.next();
		System.out.print("Fiyat�:");
		double araSicakFiyati = scan.nextDouble();
		System.out.print("Maliyeti:");
		double araSicakMaliyeti = scan.nextDouble();
		System.out.print("Kalorisi:");
		double araSicakKalorisi = scan.nextDouble();
		System.out.println("�r�n eklendi.");
		dosyaYazma("AraSicaklar.txt",
				araSicakAdi + " " + araSicakFiyati + " TL " + araSicakMaliyeti + " TL " + araSicakMaliyeti + " kalori");
		...
		dosyaYazma("MenuLog.txt",
				tarih.format(gorunum) + " tarihinde \"" + araSicakAdi + "\" eklendi.");
		dosyaYazma("log.txt", tarih.format(gorunum) + " tarihinde \"" + araSicakAdi + "\" eklendi.");
	}
	...
	public void guncelle() throws IOException {
		...
		File file2 = new File("AraSicaklar.txt");
		if (file2.exists()) {
			file2.delete();
			if (!file2.exists()) {
				try {
					file2.createNewFile();
					File file3 = new File("AraSicaklar.txt");
	...
	public void araSicaklarKontrol() throws IOException {
		Menu menu = new Menu();
